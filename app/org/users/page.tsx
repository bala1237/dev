...
export default async function OrganizationUsersPage() {
  try {
    ...
    //http://localhost:3000/api/organizations/org_1/users
    //getApiUrl(`organizations/${organizationId}/users`), {

    const response = await fetch(`http://localhost:3000/api/organizations/org_1/users`, {
      method: 'GET',
      headers: {
